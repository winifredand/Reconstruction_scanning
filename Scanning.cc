...
int main()
{
	...
	double delt_new, delt_old = 2E-2;  //The init step length;
	double x_new[101], x_old[101];
	double y_new[101], y_old[101];
	double z_new[101], z_old[101];
	...
	for (int i = 0; i < 2; i++)
	{
		x_down_old = -1, y_down_old = -1, z_down_old = -1;
		delt_old = 2E-2;
	...
	//system("pause");
		...
		do
		{
			...
			k++;
		} while (fabs(Like_old - Like_new) > 1E-10);  //The eps = 1E-10;
